...
public class Ci_DateDao {
	...
	public int insert(HashMap<String,Object> hMap) throws Exception{
		...
		try{
			result = session.insert("crossit.gandhi.dao.Ci_DateDao.insert", hMap);
			session.commit();
		}
		catch(Exception e){
	...
	public ArrayList<HashMap<String,Object>> selectList(HashMap<String,Object> hMap) throws Exception{  
		...
		try {
			result = (ArrayList)session.selectList("crossit.gandhi.dao.Ci_DateDao.selectList", hMap) ;
		}catch(Exception e) {
	...
	public HashMap<String,Object> selectOne(HashMap<String,Object> hMap) throws Exception{  
		...
		try {
			result = (HashMap<String,Object>)session.selectOne("crossit.gandhi.dao.Ci_DateDao.selectOne", hMap) ;
		}catch(Exception e) {
			logger.error(e.getMessage(), e);	throw e; 	
		}finally {
			if(session != null) { try{ session.close(); }catch(Exception e){} }
	...
	public Integer selectTotal(HashMap<String,Object> hMap) throws Exception{   
		...
		try {
			result = (Integer)session.selectOne("crossit.gandhi.dao.Ci_DateDao.selectTotal", hMap) ;
		}catch(Exception e) {
			logger.error(e.getMessage(), e);	
			throw e;
		}finally {
	...
	public int update(HashMap<String,Object> hMap) throws Exception{ 
		...
		try{
			result = (Integer) session.update("crossit.gandhi.dao.Ci_DateDao.update", hMap);
			session.commit();
		}catch(Exception e) {
			logger.error(e.getMessage(), e);	throw e;
		}finally {
	...
	public int delete(HashMap<String,Object> hMap) throws Exception{ 
		...
		try{
			result = (Integer) session.delete("crossit.gandhi.dao.Ci_DateDao.delete", hMap);
			session.commit();
		}catch(Exception e) {
			logger.error(e.getMessage(), e);	throw e;
		}finally {
